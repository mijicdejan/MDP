...
public class ChangePasswordForm extends JDialog {
	...
	private void btnConfirmClicked() {
		...
		if("".equals(password)) {
			...
			JOptionPane.showMessageDialog(null, "Nekorektan unos trenutne lozinke.");
		} else if(!newPassword.equals(newPasswordConfirm)) {
			JOptionPane.showMessageDialog(null, "Dva unosa nove lozinke se ne poklapaju.");
		} else if(putJSON(newPassword)) {
			JOptionPane.showMessageDialog(null, "Lozinka uspješno promijenjena.");
			setVisible(false);
			dispatchEvent(new WindowEvent(this, WindowEvent.WINDOW_CLOSING));
		} else {
			JOptionPane.showMessageDialog(null, "Neuspješna promjena lozinke.");
		}
	}
