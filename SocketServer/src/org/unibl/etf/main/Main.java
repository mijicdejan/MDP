...
import org.unibl.etf.monitoring.MonitoringAdminServer;
import org.unibl.etf.monitoring.MonitoringUserServer;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		new MonitoringUserServer().start();
		new MonitoringAdminServer().start();
	...
	public static void addMonitorOut(String username, ObjectOutputStream out) {
		usersMonitorOut.put(username, out);
	}
	
	public static ObjectInputStream getMonitorIn(String username) {
		return usersMonitorIn.get(username);
	}
	
	public static ObjectOutputStream getMonitorOut(String username) {
		return usersMonitorOut.get(username);
	}
	
	public static void removeMonitorIn(String username) {
		usersMonitorIn.remove(username);
	}
	
	public static void removeMonitorOut(String username) {
		usersMonitorOut.remove(username);
	}
