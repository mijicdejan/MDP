...
public class BlockUnblockForm extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public BlockUnblockForm(ArrayList<User> users, MainForm mainForm) {
		...
		addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				BlockUnblockForm.this.windowClosing();
			}
		});
		...
		btnBlock.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(index == -1) {
					...
					blockedUsers.add(user);
					blockedUsers.sort(Comparator.comparing(User::getFirstName).thenComparing(User::getLastName).thenComparing(User::getUsername));
					initUsersTable("active");
				}
			}
		});
		...
		btnUnblock.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(index == -1) {
					...
					activeUsers.add(user);
					activeUsers.sort(Comparator.comparing(User::getFirstName).thenComparing(User::getLastName).thenComparing(User::getUsername));
					initUsersTable("blocked");
				}
			}
		});
